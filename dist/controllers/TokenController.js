...
class TokenController{ //Aqui estamos a criar o nosso controller
  async store(req, res){//Aqui estamos a criar o método store, que é o método que vai receber os dados do usuário e retornar o token
    ...
    const user = await _User2.default.findOne({ where: { email } });//Aqui estamos a buscar o usuário no banco de dados pelo email
...
exports. default = new TokenController();//Aqui estamos a exportar uma nova instância do TokenController
